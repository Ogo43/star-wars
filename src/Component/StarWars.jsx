      ...
      <main className="content_general">
        <div className="content">
          {filmData?.results ? (
              ...
              return (
                <div className="sub-title1">
                  <div className="sub-content">
                    ...
                    <p className="content1">{`${result.opening_crawl.substring(
                      0,
                      100
                    )}....`}</p>
            ...
            <div className="false">Loading....</div>
          )}
      ...
      {user.length > 0 && (
        ...
        {users.map(user => (
          ...
          {/* <div className="sub-title2">
            ...
            <p className="content1">
            It is a dark time for the Rebellion. Although the Death Star has been destroyed, Imperial troops have driven the Rebel forces from their hidden base and pursued them across the galaxy. Evading the dreaded Imperial Starfleet, a group of freedom fight...
            </p>
          ...
          <div className="sub-title3">
            <div className="sub-content">
            <h3 className="title1">Return of the Jedi</h3>
            <p className="date1">May 25, 1983</p>

            <p className="content1">
             Luke Skywalker has returned to his home planet of Tatooine in an attempt to rescue his friend Han Solo from the clutches of the vile gangster Jabba the Hutt. Little does Luke know that the GALACTIC EMPIRE has secretly begun construction on a new arm...
            </p>
          ...
          <div className="sub-title4">
            <div className="sub-content">
            <h3 className="title1">The Phantom Menace</h3>
            <p className="date1">May 19, 1999</p>

            <p className="content1">
              Turmoil has engulfed the Galactic Republic. The taxation of trade routes to outlying star systems is in dispute. Hoping to resolve the matter with a blockade of deadly battleships, the greedy Trade Federation has stopped all shipping to the small pla...
            </p>
          ...
          <div className="sub-title5">
            <div className="sub-content">
            <h3 className="title1">Attack of the Clones</h3>
            <p className="date1">May 16, 2002</p>

            <p className="content1">
             There is unrest in the Galactic Senate. Several thousand solar systems have declared their intentions to leave the Republic. This separatist movement, under the leadership of the mysterious Count Dooku, has made it difficult for the limited number of...
            </p>
          ...
          <div className="sub-title6">
            <div className="sub-content">
            <h3 className="title1">Revenge of the Sith</h3>
            <p className="date1">May 19, 2005</p>

            <p className="content1">
              War! The Republic is crumbling under attacks by the ruthless Sith Lord, Count Dooku. There are heroes on both sides. Evil is everywhere. In a stunning move, the fiendish droid leader, General Grievous, has swept into the Republic capital and kidnappe...
            </p>
